...
MainSection:NewButton("Teleport to crim base", "Teleports you to criminal base", function(v)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-919.577148, 95.327179, 2130.32495, -0.0693258122, 1.40396983e-08, 0.997594059, 1.61146865e-08, 1, -1.29537003e-08, -0.997594059, 1.51778892e-08, -0.0693258122
)
end)
...
if _G.BubbleGumSimulator == true then 
    ...
    local Main = Window:NewTab("Main")
    local Section = Main:NewSection("Farming")
    Section:NewToggle("Auto farm", "Farms bubble gum", function(bool)
        getgenv().autofarmgum = bool
    end)
...
Section:NewButton("Quick sell gum", "Sells gum", function(v)
        local args = {
    [1] = "Teleport",
    [2] = "Sell"
}
